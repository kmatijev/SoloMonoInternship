...
namespace DService
{
    public class PDService : IService
    {
        ...
        public async Task<List<Grade>> GetAllGrades(string order, string sort, int page, string atribute, string filter) => await Repo.GetAllGrades(order, sort, page, atribute, filter);
        ...
        public async Task<List<Student>> GetAllStudents(string order, string sort, int page, string atribute, string filter) => await Repo.GetAllStudents(order, sort, page, atribute, filter);
