...
namespace WebAPI.Controllers
{
    ...
    {
        private PDService SerStud = new PDService();
        ...
        {
            List<Student> StudentList = await SerStud.GetStudent(id);
        ...
        {
            Student returnStudent = await SerStud .PostStudent(id, gradeId, value);
        ...
        {
            string combinedString = await SerStud.PutStudent(id, value);
        ...
        {
            string returnString = await SerStud.DeleteStudent(id);
    ...
    {
        private PDService SerGrade = new PDService();
        ...
        public async Task<HttpResponseMessage> Get(int id)
        {
            ...
            List<Grade> GradeList = await SerGrade.GetGrade(id);
        ...
        {
            Grade returnGrade = await SerGrade.PostGrade(id, value);
        ...
        public async Task<HttpResponseMessage> Put(int id, [FromBody] string value)
        {
            string combinedString = await SerGrade.PutGrade(id, value);
        ...
        public async Task<HttpResponseMessage> Delete(int id)
        {
            string returnString = await SerGrade.DeleteGrade(id);
