...
namespace Service.Common
{
    public interface IService
    {
        ...
        Task<List<Grade>> GetAllGrades(string order, string sort, int page, string atribute, string filter);
        ...
        Task<List<Student>> GetAllStudents(string order, string sort, int page, string atribute, string filter);
